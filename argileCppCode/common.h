...
MVector getVertexTangent(MFnMesh& fnInputMesh, MItMeshVertex& meshVertIt, int theVertexNumber);
MVector getVertexTangentFromFace(MFnMesh& fnInputMesh, MIntArray& connectedFaces, int theVertexNumber);
